    ...
    <form action="/modify" method="POST" class="modify-form">
    	<div class = form>
        	...
        	<label for="pw">비밀번호:</label>
        		<input type="password" id="pw" name="pw" placeholder="********" value="" required><br>
        
        	<label for="phone">전화번호:</label>
	        	<input type="text" name="phone" pattern="010-\d{3,4}-\d{4}" placeholder="${member.phone}" title="010-XXXX-XXXX로 입력." required>
        </div>
